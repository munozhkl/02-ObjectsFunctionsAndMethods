...
def turtle4():
    jessie = rg.SimpleTurtle()
    jessie.pen = rg.Pen('BlueViolet', 10)
    jessie.draw_regular_polygon(9, 30)


def turtle5():
    harold = rg.SimpleTurtle()
    betty = rg.SimpleTurtle()
    harold.pen = rg.Pen('gray', 30)
    betty.pen = rg.Pen('gold', 20)
    harold.forward(500)
    betty.backward(500)
